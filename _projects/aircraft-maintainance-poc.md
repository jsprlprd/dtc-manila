...
<div class="container">
    <div class="heading">
        <h1 class="heading-title">Aircraft Maintenance POC</h1>
        <p class="heading-subtitle">Application that securely monitors and manages maintenance, repair, and overhaul operations of aircrafts and their components</p>
    </div>
